<div class="row page-titles">
    ...
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            ...
            <button type="button" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> <?=$this->lang->line('AddEdit_Training_category');?></button>
        </div>
    </div>
</div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h6 class="card-subtitle"><?php echo $this->lang->line("addTraining_mess");?></h6>
                ...
                <form method="post" enctype="multipart/form-data" id="school_form" novalidate>
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <h5><?=$this->lang->line('trc_name');?>  <span class="text-danger">*</span></h5>
                            <div class="controls">
                                <?php $hasil ="1111";?>
                                <input type="text" class="form-control" id="trc_name" name="trc_name"  required data-validation-required-message="<?=$this->lang->line('required');?> "/>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="d-flex no-block align-items-center">
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <input id="trc_active" class="room_active custom-control-input " name="trc_active" type="checkbox" checked />
        ...
        <div class="card">
            <div class="card-body">
                ...
                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                    <thead>
                    <tr>
                        <th><?php echo $this->lang->line("trc_name");?></th>
...
<script type="text/javascript">
    $(document).ready(function(e) {
        draw("<?=base_url()?>Constants_ci/get_items/Training_categories/trc_code/trc_name/trc_active" , "#tdata");
        $("#school_form").submit(function(e){
            ...
            $.ajax({
                url : '<?=base_url()?>Constants_ci/AddEdit_Training_category' ,
                method: 'POST',
                data: formData,
        ...
        $(document).on('click','.Edit',function(){
            ...
            var trc_name = $(this).attr('trc_name');
            var trc_active = $(this).attr('trc_active');
            $("#curr_code").val(pk);
            $("#trc_name").val(trc_name);
            if(trc_active == 1)
                $("#trc_active").attr('checked', true);
            else
                $("#trc_active").attr('checked', false);
        ...
        $(document).on('click','.Del',function(){
            ...
            swal({
                ...
                if (result.value) {
                    draw("<?=base_url()?>Constants_ci/del_items/Training_categories/trc_code/"+pk , "");
                    draw("<?=base_url()?>Constants_ci/get_items/Training_categories/trc_code/trc_name/trc_active" , "#tdata");
