...
<select class="select2 form-control custom-select" id="res_room_code" name="res_room_code" required data-validation-required-message="<?=$this->lang->line('required');?> ">
		 ...
		 <div class="form-group">
                                        ...
                                        <div class="controls">
<input type='text'  class="form-control" id="min-date9" name="res_time_start"  required data-validation-required-message="<?=$this->lang->line('required');?> " />              </div>
				</div> 
				</div> 
		  			 <div class="col-md-6">
		 <div class="form-group">
                                        ...
                                        <div class="controls">
<input type='text'  class="form-control" id="min-date8" name="res_time_end"  required data-validation-required-message="<?=$this->lang->line('required');?> " />              </div>
				</div> 
				</div> 		
