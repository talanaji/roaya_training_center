 ...
 <form method="post" enctype="multipart/form-data" id="school_form" novalidate>
			      ...
			      <img src='<?=base_url()?>/public/assets/images/icon/printer.png' id="print" name="print" class="print"/>
                    ...
                    <div class="col-12">
						...
						<tr>
							...
							<th><?php echo $this->lang->line("res_time_start");?></th>
                            <th><?php echo $this->lang->line("res_time_end");?></th>
									<th><?php echo $this->lang->line("rest_name");?></th>
                            <th><?php echo $this->lang->line("res_teach_note");?></th>
						</tr>
						</thead>
						<tfoot>
						<tr>
	...
	$(document).ready(function(e) {
		  draw("<?=base_url()?>Reports/get_reservations/0/0/all/0/0" , "#tdata");
function printData()
{
