				...
				<div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    <div class="align-self-center "><img src="<?=base_url()?>public/assets/images/icon/calendar2.png"/></div>
                                    <div class="m-l-10 align-self-center">
                                        <h4 class="m-b-0"><?php echo $sum_today?> <?php echo $this->lang->line("hours");?></h4>
                                        <h5 class="text-muted m-b-0"><?php echo $this->lang->line("all_clock_in_today");?></h5></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                 <div class="align-self-center "><img src="<?=base_url()?>public/assets/images/icon/calendar.png"/></div>
                                    <div class="m-l-10 align-self-center">
                                        <h4 class="m-b-0"><?php echo $sum1?> <?php echo $this->lang->line("itsok");?></h4>
                                        <h5 class="text-muted m-b-0"><?php echo $this->lang->line("all_clock_in_month");?></h5></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                      <div class="align-self-center "><img src="<?=base_url()?>public/assets/images/icon/calendar3.png"/></div>
                                    <div class="m-l-10 align-self-center">
                                        <h4 class="m-b-0"><?php echo $GetAllAmontHourMonth?> <?php echo $this->lang->line("itsnotok");?></h4>
                                        <h5 class="text-muted m-b-0"><?php echo $this->lang->line("all_clock_in_month");?></h5></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                <div class="align-self-center "><img src="<?=base_url()?>public/assets/images/icon/bank.png"/></div>
                                    <div class="m-l-10 align-self-center">
                                        <h4 class="m-b-0"><?php echo $st_sum?>  <?php echo $this->lang->line("shekel_for_this_month");?></h4>
                                        <h5 class="text-muted m-b-0"><?php echo $this->lang->line("Profit_this_month");?><?php echo $st_sum2?></h5></div>
                                </div>
                            </div>
                        </div>
                    </div>
		...
		<?php 
			 ...
			 { $time_start = strtotime($dd->res_time_start);
                      ...
                      $monthdata =  date('Y-m-d',strtotime($dd->res_time_start)) ; 	
	                	//$d6 = $monthdata -$day;
       				//  echo $d6; 
 				 //if( $d6 == 0 | $dd->res_is_confirmed ==0)
 				// if( $monthdata == $day || $dd->res_is_confirmed ==0)
 			if( $monthdata <= $day &&  $dd->res_is_confirmed ==0)
				 { 
