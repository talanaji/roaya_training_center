...
<!-- 
   <!-- Row -->
      ...
      <form method="post" enctype="multipart/form-data" id="student_form">
      ...
      <hr class="light-grey-hr"/>
         <div class="row">
             <div class="col-md-6">
                 <div class="form-group">
                     <label class="control-label mb-10"><?=$this->lang->line('crs_cat');?></label>
                     <select class="form-control" id="tr_cat_code" name="tr_cat_code">
                         <option value=""><?=$this->lang->line('choose');?></option>
                         <?php
                         draw_lists("training_categories" , "trc_code" , "trc_name","trc_active","1");
                         ?>
                     </select>
             ...
             <div class="col-md-6">
                 ...
                 <label class="control-label mb-10">
                       ...
                       <input type="text" class="form-control" id="crs_name" name="crs_name" required/>
	   ...
	   <div class="col-md-12">
		<div class="form-group">
		 ...
		 <div class="col-md-6">
			<div class="form-group">
			     <label class="control-label mb-10"><?=$this->lang->line('crs_keywords');?></label> <span class="card-subtitle">(<?=$this->lang->line('crs_keywords_msg');?>) </span>
			     
			  <br/>
                         <input type="text" class="form-control col-md-12" id="crs_keywords" name="crs_keywords"   data-role="tagsinput" />
        ...
        <div class="col-md-6">
			...
			<div class="form-group">
			  <label class="control-label mb-10"><?=$this->lang->line('crs_duration');?></label>
				  <input type="text" class="form-control" id="crs_duration" name="crs_duration" />
				 	<span class="help-block"> </span>
				 </div>
			</div>
		 ...
		 <div class="col-md-6">
			<div class="form-group">
			  <label class="control-label mb-10"><?=$this->lang->line('crs_author');?></label>
                  <select class="js-example-basic-multiple select2 form-control" id="crs_author" name="crs_author[]" multiple="multiple">
				         <option value=""><?=$this->lang->line('choose');?></option>
                        <?php
			...
			<div class="form-group">
             ...
             <div class="col-md-6">
                 <div class="form-group">
                     ...
                     <input type="text" class="form-control" id="crs_hours" name="crs_hours" required />
                     <span class="help-block"> </span>
                 </div>
             </div>
	    ...
	    <div class="form-group row">
          <div class="col-md-12">
              <div class="d-flex no-block align-items-center">
                <div class="custom-control custom-checkbox">
	                <input  type="checkbox" class="custom-control-input " id="crs_show_pricea" name="crs_show_pricea"   />
                       <label class="custom-control-label" for="crs_show_pricea"> <?=$this->lang->line('crs_show_price');?></label>
				 </div>
             </div>
           </div>
         </div>
          ...
          <div class="form-group row">
              <div class="col-md-12">
                  <div class="d-flex no-block align-items-center">
                      <div class="custom-control custom-checkbox">
                          <input  type="checkbox" class="custom-control-input " id="crs_is_preview" name="crs_is_preview"   />
                          <label class="custom-control-label" for="crs_is_preview"> <?=$this->lang->line('crs_is_preview');?></label>
                      </div>
                  </div>
              </div>
          </div>
	      <div class="form-group row">
            <div class="col-md-12">
               <div class="d-flex no-block align-items-center">
                    <div class="custom-control custom-checkbox">
						  <input  type="checkbox" class="te_active custom-control-input " id="crs_active" name="crs_active"   />
...
<div class="row">
  ...
  $(window).keydown(function(event){
    if(event.keyCode == 13) {
      ...
      return false;
		  ...
		  draw("<?=base_url()?>Courses_ci/get_items/training_courses/crs_code/crs_name/crs_active" , "#tdata");
		 $('.js-example-basic-multiple').select2();
		  ...
		  $(document).on('click','.Edit',function(){ 
				...
				var pk = $(this).attr('title');
 				...
 				var crs_keywords = $(this).attr('crs_keywords');
				...
				var crs_show_price = $(this).attr('crs_show_pricea');
				var crs_author = $("#crs_author");
				var crs_ages = $(this).attr('crs_ages');
				var tr_cat_code = $(this).attr('tr_cat_code');
		...
		fetch_per_params( '<?=base_url()?>Common/fetch_this_photos', '#this_photos', pk, _PREFIX(), 1 ); //fetch all users
              $.ajax({
                  url:"<?=base_url()?>Courses_ci/get_training_teachs",
                  type:"POST",
			...
			$( "#this_photos" ).css( "display", "block" );
				...
				$('#crs_keywords').tagsinput('add', crs_keywords);
               ...
               if(crs_show_price == 1)
                  $("#crs_show_pricea").attr('checked', true);
              else
                  $("#crs_show_pricea").attr('checked', false);
  ...
  if (result.value) {
	draw("<?=base_url()?>Courses_ci/del_items/training_courses/crs_code/"+pk , "");
						draw("<?=base_url()?>Courses_ci/get_items/training_courses/crs_code/crs_name/crs_active" , "#tdata");
	// location.reload();
  }
})
