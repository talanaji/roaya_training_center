                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            Copyright © 2019 <a href="#">Asa'd Mansour</a>.
                        </div>
...
//http://www.xaprb.com/blog/2005/12/12/javascript-closures-for-runtime-efficiency/
    ...
    <script src="<?=base_url()?>public/assets/plugins/dropify/js/dropify.min.js"></script>
    ...
    <script src="<?=base_url()?>public/assets/js/form/dropify.js"></script>
    <script src="<?=base_url()?>public/assets/js/page/summernote.js"></script>
    <script src="<?=base_url()?>public/assets/js/page/dialogs.js"></script>
