                  ...
                  <hr class="light-grey-hr"/>
                     <div class="row">
                            <div class="col-md-6">
							   ...
							   <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label mb-10">ICON</label>
                                    <input type="text" id="icon"   name="icon" value="<?= !empty($icon)? $icon:""?>" class="form-control" placeholder="">
                                 </div>
                            </div>
                   </div>
     		   </div>
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-9">
                    <div class="checkbox checkbox-success">
                        ...
                        <label for="checkbox_34">مفعل</label>
                    </div>
                </div>
            </div>
												...
												<tbody>
													...
													<tr>
														...
														<td>
                                                             ...
                                                             <a href="<?=base_url()?>permissions/addEdit_menu/<?=$men->m_code?>/<?=$men->icon?>"><button type='button' class='btn waves-effect waves-light btn-info'><?=$this->lang->line('edit')?></button></a>
                                                           </td>
 													</tr>
